...
set :deploy_url, Figaro.env.deploy_url
set :repo_owner, Figaro.env.repo_owner
set :repo_name, fetch(:application)
set :repo_url, "git@github.com:#{fetch(:repo_owner)}/#{fetch(:repo_name)}-backend.git"
set :branch, :main
set :rbenv_ruby, '3.1.2'
set :deploy_to, "/home/ubuntu/#{fetch(:application)}-backend"
set :shared_path, "#{fetch(:application)}/shared"
